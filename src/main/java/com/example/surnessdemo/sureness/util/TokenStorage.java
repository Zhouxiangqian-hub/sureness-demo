package com.example.surnessdemo.sureness.util;
...
public class TokenStorage {
    ...
    public static boolean matchToken(String key, String currentToken) {
        ...
        if (Long.parseLong(tokenArr[START_TIME_INDEX]) + Long.parseLong(tokenArr[PERIOD_TIME_INDEX]) <= System.currentTimeMillis()) {
